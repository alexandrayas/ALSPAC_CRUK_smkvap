...
ggsave(sel_corr, width=8,   height=8, filename = 'C:/path/to/user/outputs/folder/selection_corr_mat_plt.png')
```
...
ggsave(sel_pred, width=8,   height=8, filename = 'C:/path/to/user/outputs/folder/selection_pred_mat_plt.png')
```
...
ggsave(ana_corr, width=8,   height=8, filename = 'C:/path/to/user/outputs/folder/analytic_corr_mat_plt.png')
```
...
ggsave(ana_pred, width=8,   height=8, filename = 'C:/path/to/user/outputs/folder/analytic_pred_mat_plt.png')
```
