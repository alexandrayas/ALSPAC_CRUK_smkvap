...
## YPA/YPB/YPC/YPD/YPH/YPK G1 self questionnaires
#YPA9020 YPA6000 YPA6010 YPA6020 YPA6030 YPA9010 YPA9011
#YPB9992 YPB4000 YPB4010 YPB4090 YPB4100
#YPC2650 YPC1350 YPC1360 YPC1420 YPC1440
#YPD9650 YPD7000 YPD7010 YPD7070 YPD7090
#YPH9520 YPH5510 YPH5610 YPH5620
#YPK9510 YPK6010 YPK6040 YPK6520 YPK6540 YPK9021 YPK9022

## F24 G1 clinic
#FKAR0010 FKSM1010 FKSM1040 FKSM1200 FKSM1210

# LOAD PACKAGES AND DATA
library(haven)
library(xlsx)
vap <- read_dta('//path/to/files/vaping_vars_ALSPAC.dta')
...
## 28 years (no 'ever smoked' question)
...
## Age 30 years (uses e-cigs past 30 days not currently using)
...
vapdf$age30 <- vapdf$age30 * 12 ##asked in years
...
##replaces ages @ 30y for those with date of completion data
vapdf$losfoll <- NA
...
# SAVE
write_dta(data=vapdf, path='//path/to/files/vaping_categories.dta')
