...
save(subdistfigdat, file='C:/Users/qg21962/OneDrive - University of Bristol/Documents/CRUK smoking vaping/Vaping transitions/Outputs/subdistfigdat_unadj.rda')
...
outtabs$cc |> 
  as_gt() |> 
  gt::gtsave(filename = 'C:/Users/qg21962/OneDrive - University of Bristol/Documents/CRUK smoking vaping/Vaping transitions/Outputs/subdistsurv_cc_unadj_tab.docx')

outtabs_ecig_collapsed$cc
outtabs_ecig_collapsed$cc |> 
  as_gt() |> 
  gt::gtsave(filename = 'C:/Users/qg21962/OneDrive - University of Bristol/Documents/CRUK smoking vaping/Vaping transitions/Outputs/subdistsurv_cc_unadj_ecig_collapsed_tab.docx')
```
...
outtabs$imp |> 
  as_gt() |> 
  gt::gtsave(filename = 'C:/Users/qg21962/OneDrive - University of Bristol/Documents/CRUK smoking vaping/Vaping transitions/Outputs/subdistsurv_imp_unadj_tab.docx')

outtabs_ecig_collapsed$imp
outtabs_ecig_collapsed$imp |> 
  as_gt() |> 
  gt::gtsave(filename = 'C:/Users/qg21962/OneDrive - University of Bristol/Documents/CRUK smoking vaping/Vaping transitions/Outputs/subdistsurv_imp_unadj_ecig_collapsed_tab.docx')
```
...
outtabs$imp_w |> 
  as_gt() |> 
  gt::gtsave(filename = 'C:/Users/qg21962/OneDrive - University of Bristol/Documents/CRUK smoking vaping/Vaping transitions/Outputs/subdistsurv_imp_unadj_w_tab.docx')

outtabs_ecig_collapsed$imp_w
outtabs_ecig_collapsed$imp_w |> 
  as_gt() |> 
  gt::gtsave(filename = 'C:/Users/qg21962/OneDrive - University of Bristol/Documents/CRUK smoking vaping/Vaping transitions/Outputs/subdistsurv_imp_unadj_w_ecig_collapsed_tab.docx')
```

```{r difference-between-cause-specific-and-subdistribution-dataLong}
#> causp_impdfsLong[[1]]$nonuse[causp_impdfsLong[[1]]$nonuse$obj %in% 11, c('obj','timeInt','y',vaps)]
#     obj timeInt y             vap22             vap23    vap24    vap28    vap30
#11    11       1 0 Exclusive smoking Exclusive smoking Dual use Dual use Dual use
#11.1  11       2 0 Exclusive smoking Exclusive smoking Dual use Dual use Dual use
#11.2  11       3 0 Exclusive smoking Exclusive smoking Dual use Dual use Dual use

#> subdist_impdfsLong[[1]]$nonuse[subdist_impdfsLong[[1]]$nonuse$obj %in% 11, c('obj','timeInt','y',vaps)]
#     obj timeInt y             vap22             vap23    vap24    vap28    vap30
#11    11       1 0 Exclusive smoking Exclusive smoking Dual use Dual use Dual use
#11.1  11       2 0 Exclusive smoking Exclusive smoking Dual use Dual use Dual use
#11.2  11       3 0 Exclusive smoking Exclusive smoking Dual use Dual use Dual use
#11.3  11       4 0 Exclusive smoking Exclusive smoking Dual use Dual use Dual use
#11.4  11       5 0 Exclusive smoking Exclusive smoking Dual use Dual use Dual use

#competing risk events stay is risk set in subdistribution survival models
