...
save(subdistfigdat, file='C:/path/to/user/outputs/folder/subdistfigdat_adj.rda')
...
outtabs$cc |> 
  as_gt() |> 
  gt::gtsave(filename = 'C:/path/to/user/outputs/folder/subdistsurv_cc_adj_tab.docx')

outtabs_ecig_collapsed$cc
outtabs_ecig_collapsed$cc |> 
  as_gt() |> 
  gt::gtsave(filename = 'C:/path/to/user/outputs/folder/subdistsurv_cc_adj_ecig_collapsed_tab.docx')
```
...
outtabs$imp |> 
  as_gt() |> 
  gt::gtsave(filename = 'C:/path/to/user/outputs/folder/subdistsurv_imp_adj_tab.docx')

outtabs_ecig_collapsed$imp
outtabs_ecig_collapsed$imp |> 
  as_gt() |> 
  gt::gtsave(filename = 'C:/path/to/user/outputs/folder/subdistsurv_imp_adj_ecig_collapsed_tab.docx')
```
...
outtabs$imp_w |> 
  as_gt() |> 
  gt::gtsave(filename = 'C:/path/to/user/outputs/folder/subdistsurv_imp_adj_w_tab.docx')

outtabs_ecig_collapsed$imp_w
outtabs_ecig_collapsed$imp_w |> 
  as_gt() |> 
  gt::gtsave(filename = 'C:/path/to/user/outputs/folder/subdistsurv_imp_adj_w_ecig_collapsed_tab.docx')
```
