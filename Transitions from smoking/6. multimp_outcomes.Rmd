...
#save
save(imp, file='//path/to/ieu/project/folder/working/data/vaping_transitions/vaping_imp.rda')
save(impdfs, file='//path/to/ieu/project/folder/working/data/vaping_transitions/vaping_impdfs.rda')
```
...
#save
write_dta(subdf, '//path/to/ieu/project/folder/working/data/vaping_transitions/vaping_sub_measures.dta')
```
