...
library(haven)
library(labelled)
exp <- read_dta('//path/to/ieu/project/folder/working/data/vaping_transitions/vaping_exp_vars_ALSPAC.dta')
...
#SAVE
write_dta(data=expdf, path='//path/to/ieu/project/folder/working/data/vaping_transitions/vaping_exp_measures.dta')
