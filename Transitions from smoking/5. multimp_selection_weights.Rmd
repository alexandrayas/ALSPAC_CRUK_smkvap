...
#data
vapdf <- read_dta('//path/to/ieu/project/folder/working/data/vaping_transitions/vaping_categories.dta')
expdf <- read_dta('//path/to/ieu/project/folder/working/data/vaping_transitions/vaping_exp_measures.dta')
...
alldf$weights <- 1/(alldf$predicted_probs)
  ...
  #save data
write_dta(alldf, '//path/to/ieu/project/folder/working/data/vaping_transitions/vaping_all_measures.dta')
